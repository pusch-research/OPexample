Model              Client             Turbine            RD                 Hub Height
V - Dev            ARPA-E             10                 178.3              119
--- SIMULATION CONTROL ---
False               Echo               Echo input data to <RootName>.ech (flag)
FATAL              AbortLevel         Error level when simulation should abort (string) {"WARNING", "SEVERE", "FATAL"}
9999                TMax               Total run time (s)
0.0250             DT                 Recommended module time step (s)
...
"none"             Ice File           Name of file containing ice input parameters (quoted string)
--- OUTPUT ---
False              SumPrint           Print summary data to "<RootName>.sum" (flag)
99999              SttsTime           Amount of time between screen status messages (s)
99999              ChkptTime          Amount of time between creating checkpoint files for potential restart (s)
99999              DT_Out             Time step for tabular output (s) (or "default")
...
700                LinTimes           List of times at which to linearize (s) [1 to NLinTimes] [unused if Linearize=False]
